...
st.title(":money_with_wings:" + " " + page_title + " " + ":money_with_wings:")

# ----- Dropdown values -----
years = [datetime.today().year-2, datetime.today().year-1, datetime.today().year]
...
selected = option_menu(
    ...
    icons=["pencil_fill","bar_chart_fill"],
...
# ----- Submission -----
        ...
        if submitted:
            ...
            st.success("Data is saved.")

# ----- Plot periods -----
if selected == "Data Visualization":
    st.header("Data Visualization")
    with st.form("saved_form"):
